...
const STYLES = `
  ...
  .cmd-logo img{ width:100%; height:100%; object-fit:cover; }
  ...
  .cmd-wa-avatar img{ width:100%; height:100%; object-fit:cover; }
    ...
    <>
      ...
      >
        ...
        <div className="cmd-logo">
          <img src="https://cdn.callmydoctor.app/cmd-logo.png" alt="Call My Doctor" />
        </div>
        ...
        <div className="cmd-wa-header">
          <div className="cmd-wa-head-left">
            <div className="cmd-wa-avatar">
              <img src="https://cdn.callmydoctor.app/cmd-logo.png" alt="CMD" />
            </div>
            <div>
...
<div className="cmd-bubble-user">
  Hi! I want to detail of your service
  <div className="cmd-bubble-time">{timeStr}</div>
</div>


          <div className="cmd-bubble">
            Need a doctor at your location in Dubai?
            <br />
            <br />
